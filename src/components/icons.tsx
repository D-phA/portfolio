...
/** Inline SVG icons (no external icon dependency). All decorative by default;
 * callers that use an icon as the sole content of a link pass an aria-label. */
